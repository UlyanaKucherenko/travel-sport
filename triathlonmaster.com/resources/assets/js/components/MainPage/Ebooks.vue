<template>
  <section class="ebooks" id="ebooks">
    <div class="container">
      <div class="row">
        <div class="ebooks__container offset-sm-0 col-sm-12 offset-md-1 col-md-10">
          ...
          <div class="ebooks__slider">
            ...
            >
              <img :src="`/img/reasons-img-1.svg`" class="ebooks__slide" alt="">
              <img :src="`/img/reasons-img-2.svg`" class="ebooks__slide" alt="">
              <img :src="`/img/reasons-img-3.svg`" class="ebooks__slide" alt="">
              <img :src="`/img/reasons-img-4.svg`" class="ebooks__slide" alt="">
              <img :src="`/img/reasons-img-1.svg`" class="ebooks__slide" alt="">
            </Slick>
