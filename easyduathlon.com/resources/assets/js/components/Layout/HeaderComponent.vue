...
<!--          <li>-->
<!--            <a-->
<!--              :href="createRouteLink('#about-duathlon')"-->
<!--              class="header-nav-list__link"-->
<!--              @click="showMenuToggle"-->
<!--            >{{ this.vocab[this.locale].aboutDuathlon }}</a-->
<!--            >-->
<!--          </li>-->
          <li>
            <a
...
<!--          <li>-->
<!--            <a-->
<!--              :href="createRouteLink('#tips')"-->
<!--              class="header-nav-list__link"-->
<!--              @click="showMenuToggle"-->
<!--            >{{ this.vocab[this.locale].tips }}</a-->
<!--            >-->
<!--          </li>-->
          <li v-if="is_login">
...
.header {
  ...
  &-bg {
    --header-color-bg: var(--color-header-bg-base);
    --header-color-text: var(--color-header-text);
    ...
    &--scroll {
      --header-color-bg: var(--color-header-bg-scrolled);
      --header-color-text: var(--color-header-text-scrolled);
  ...
  &-nav {
    ...
    &-list {
      ...
      &__link {
        ...
        color: var(--header-color-text, var(--color-header-text));
        font-weight: 600;
